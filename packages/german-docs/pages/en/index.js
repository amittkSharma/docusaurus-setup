...
class HomeSplash extends React.Component {
  render() {
    ...
    return ( <
        ...
        <
        Button href = {
          docUrl('wg/01_introduction/what-is-the-world-graph.html', language)
        } > World - Graph < /Button> <
        Button href = {
          docUrl('ui/01_introduction/before-we-start.html', language)
        } > UI Toolkit < /Button> {
        /* <Button href={docUrl('domain-howto.html', language)}>Guides</Button>
                    <Button href={docUrl('rest.html', language)}>API</Button> */
      } <
      /PromoSection> < /
    div > <
      /SplashContainer>
...
const Features = props => ( < Block layout = "fourColumn" > {
    [{
      ...
      {
        content: 'Deploy your domain, create instances of your concepts. You can work with it like a graph database',
        image: imgUrl('graph.png'),
        imageAlign: 'top',
        title: 'Domain as Graph',
      },
      {
        content: 'Define external linked-in data of your graph and access it in a unified way. The World Graph will take care of it.',
